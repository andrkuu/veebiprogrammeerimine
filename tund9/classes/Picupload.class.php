    ...
    public function saveImage($targetFile){
        ...
        if($this->imageFileType == "jpg" or $this->imageFileType == "jpeg"){
            if(imagejpeg($this->myNewImage, $targetFile, 90)){
                ...
                $notice = "Vähendatud pildi salvestamine ebaõnnestus1!";
            }
        }
        if($this->imageFileType == "png"){
            if(imagepng($this->myNewImage, $targetFile, 6)){
                ...
                $notice = "Vähendatud pildi salvestamine ebaõnnestus2!".$targetFile;
            }
        }
        if($this->imageFileType == "gif"){
            if(imagegif($this->myNewImage, $targetFile)){
                ...
                $notice = "Vähendatud pildi salvestamine ebaõnnestus3!";
            }
        }
